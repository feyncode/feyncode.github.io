  ...
  _createClass(Util, [
    ...
    },
    {
      ...
      value: function getScrollTop() {
        ...
        return (
          (_document$documentEle = document.documentElement) !== null &&
          _document$documentEle !== void 0
...
var FixIt = (function () {
  ...
  _createClass(FixIt, [
    {
      key: "initThemeColor",
      value: function initThemeColor() {
        var _this3 = this;
        var $meta = document.querySelector('[name="theme-color"]');
        if (!$meta) {
          return;
        }
    ...
    },
    {
      ...
      value: function initMenuDesktop() {
        this.util.forEach(
          document.querySelectorAll(".has-children, #header-desktop .language"),
          function ($item) {
            $item.addEventListener("mouseover", function () {
              this.querySelector(".sub-menu").style.left = "".concat(
                this.getBoundingClientRect().left,
                "px"
              );
            });
            $item.querySelector(".sub-menu").style.minWidth = "".concat(
              $item.offsetWidth - 8,
              "px"
            );
          }
    ...
    },
    {
      ...
      value: function initMenuMobile() {
        ...
        this.util.forEach(
          document.querySelectorAll(".menu-item>.nested-item"),
          function ($nestedItem) {
      ...
      value: function initSearch() {
        ...
        if (isMobile) {
          ...
          $searchInput.addEventListener(
            "focus",
            function () {
              _this6.disableScrollEvent = true;
          ...
          document.getElementById("search-cancel-mobile").addEventListener(
            "click",
            function () {
              _this6.disableScrollEvent = false;
              ...
              _this6._searchMobile &&
                _this6._searchMobile.autocomplete.setVal("");
            },
            false
          );
          ...
          $searchClear.addEventListener(
            ...
            function () {
              $searchClear.style.display = "none";
              _this6._searchDesktop &&
                _this6._searchDesktop.autocomplete.setVal("");
            },
            false
          );
        ...
        var initAutosearch = function initAutosearch() {
              ...
              source: function source(query, callback) {
                ...
                if (searchConfig.type === "lunr") {
                  var search = function search() {
                    ...
                    var results = {};
                    _this6._index.search(query).forEach(function (_ref) {
                      var ref = _ref.ref,
                        metadata = _ref.matchData.metadata;
                      var matchData = _this6._indexData[ref];
          ...
          if (isMobile) {
            _this6._searchMobile = autosearch;
          } else {
            _this6._searchDesktop = autosearch;
          }
        };
        if (
          ...
          function ($chroma) {
            ...
            if ($codeElements.length) {
              ...
              $ellipses.insertAdjacentHTML(
                "afterbegin",
                '<i class="fa-solid fa-ellipsis-h fa-fw" aria-hidden="true"></i>'
              );
              ...
              if (_this8.config.code.editable) {
                var $edit = document.createElement("span");
                $edit.classList.add("edit");
                $edit.insertAdjacentHTML(
                  "afterbegin",
                  '<i class="fa-solid fa-key fa-fw" title="'.concat(
                    _this8.config.code.editUnLockTitle,
                    '" aria-hidden="true"></i>'
                  )
                );
                $edit.addEventListener(
                  ...
                  function () {
                    ...
                    var $preChromas =
                      $edit.parentElement.parentElement.querySelectorAll(
                        "pre.chroma"
                      );
                    var $preChroma =
                      $preChromas.length === 2
              ...
              if (_this8.config.code.copyTitle) {
                var $copy = document.createElement("span");
                $copy.insertAdjacentHTML(
                  "afterbegin",
                  '<i class="fa-regular fa-copy fa-fw" aria-hidden="true"></i>'
                );
                $copy.classList.add("copy");
                var code = $code.innerText;
                if (
                  _this8.config.code.maxShownLines < 0 ||
                  code.split("\n").length < _this8.config.code.maxShownLines + 2
                ) {
                  $chroma.classList.add("open");
                }
                $copy.title = _this8.config.code.copyTitle;
                $copy.addEventListener(
                  "click",
                  function () {
                    navigator.clipboard.writeText(code).then(
                      function () {
                        _this8.util.animateCSS($code, "animate__flash");
                      },
                      function () {
                        console.error(
    ...
    },
    {
      ...
      value: function initToc() {
        ...
        if (
          document.getElementById("toc-static").getAttribute("date-kept") ===
            "true" ||
          ...
          $toc.style.marginBottom =
            document.getElementById("post-footer").clientHeight + "px";
          ...
          this._tocOnScroll =
            ...
            function () {
              ...
              _this9.util.forEach($tocLinkElements, function ($tocLink) {
                $tocLink.classList.remove("active");
              });
              _this9.util.forEach($tocLiElements, function ($tocLi) {
        ...
        (_document$querySelect = document.querySelector(
          ...
          : _document$querySelect.addEventListener(
              ...
              function () {
                ...
                animation.push(
                  tocHidden ? "animate__fadeIn" : "animate__fadeOut"
                );
                $tocContentAuto.classList.remove(
                  tocHidden ? "animate__fadeOut" : "animate__fadeIn"
                );
                _this10.util.animateCSS($tocContentAuto, animation, true);
        ...
        this._mermaidOnSwitchTheme =
          ...
          function () {
            ...
            if ($mermaidElements.length) {
              var _this11$config$mermai;
              var themes =
                (_this11$config$mermai = _this11.config.mermaid.themes) !==
                  null && _this11$config$mermai !== void 0
                  ? _this11$config$mermai
                  : ["neutral", "dark"];
              mermaid.initialize({
                startOnLoad: false,
                theme: _this11.isDark ? themes[1] : themes[0],
                securityLevel: "loose",
              });
              _this11.util.forEach($mermaidElements, function ($mermaid) {
                mermaid.render(
                  "svg-" + $mermaid.id,
                  _this11.data[$mermaid.id],
                  function (svgCode) {
    ...
    },
    {
      ...
      value: function initEcharts() {
        ...
        this._echartsOnSwitchTheme =
          this._echartsOnSwitchTheme ||
          function () {
            _this12._echartsArr = _this12._echartsArr || [];
            for (var i = 0; i < _this12._echartsArr.length; i++) {
              _this12._echartsArr[i].dispose();
            }
            _this12._echartsArr = [];
            _this12.util.forEach(
              document.getElementsByClassName("echarts"),
              function ($echarts) {
                var chart = echarts.init(
                  $echarts,
                  _this12.isDark ? "dark" : "light",
                  { renderer: "svg" }
                );
                chart.setOption(JSON.parse(_this12.data[$echarts.id]));
                _this12._echartsArr.push(chart);
              }
            );
          };
      ...
      value: function initMapbox() {
        ...
        if (this.config.mapbox) {
          ...
          this.util.forEach(
            ...
            function ($mapbox) {
              var _this13$data$$mapbox$ = _this13.data[$mapbox.id],
                lng = _this13$data$$mapbox$.lng,
                lat = _this13$data$$mapbox$.lat,
                zoom = _this13$data$$mapbox$.zoom,
                lightStyle = _this13$data$$mapbox$.lightStyle,
                darkStyle = _this13$data$$mapbox$.darkStyle,
                marked = _this13$data$$mapbox$.marked,
                navigation = _this13$data$$mapbox$.navigation,
                geolocate = _this13$data$$mapbox$.geolocate,
                scale = _this13$data$$mapbox$.scale,
                fullscreen = _this13$data$$mapbox$.fullscreen;
              var mapbox = new mapboxgl.Map({
                container: $mapbox,
                center: [lng, lat],
                zoom: zoom,
                minZoom: 0.2,
                style: _this13.isDark ? darkStyle : lightStyle,
              ...
              _this13._mapboxArr.push(mapbox);
            }
          );
          this._mapboxOnSwitchTheme =
            this._mapboxOnSwitchTheme ||
            function () {
              _this13.util.forEach(_this13._mapboxArr, function (mapbox) {
                var $mapbox = mapbox.getContainer();
                var _this13$data$$mapbox$2 = _this13.data[$mapbox.id],
                  lightStyle = _this13$data$$mapbox$2.lightStyle,
                  darkStyle = _this13$data$$mapbox$2.darkStyle;
                mapbox.setStyle(_this13.isDark ? darkStyle : lightStyle);
                mapbox.addControl(new MapboxLanguage());
              });
            };
    ...
    },
    {
      ...
      value: function initCommentLightGallery(comments, images) {
        ...
        document.querySelectorAll(comments).forEach(function ($content) {
          var $imgs = $content.querySelectorAll(
            images + ":not([lightgallery-loaded])"
          );
    ...
    },
    {
      ...
      value: function initComment() {
          ...
          this._utterancesOnSwitchTheme =
            ...
            function () {
              ...
              _document$querySelect2 === void 0
                ? void 0
                : _document$querySelect2.contentWindow.postMessage(
                    message,
                    "https://utteranc.es"
                  );
            };
        ...
        if (this.config.comment.giscus) {
          ...
          var _this = this;
          _this.giscus2parentMsg = window.addEventListener(
            "message",
            function (event) {
              ...
              "".concat(
                (_document$querySelect4 =
                  ...
                  _document$querySelect5 === void 0
                    ? void 0
                    : _document$querySelect5.outerHTML) !== null &&
      ...
      value: function onScroll() {
        ...
        $backToTop === null || $backToTop === void 0
          ...
          : $backToTop.addEventListener("click", function () {
              _this20.util.scrollIntoView("body");
            });
        window.addEventListener(
          "scroll",
          function (event) {
            if (_this20.disableScrollEvent) {
              event.preventDefault();
              return;
            }
            var $mask = document.getElementById("mask");
            _this20.newScrollTop = _this20.util.getScrollTop();
            var scroll = _this20.newScrollTop - _this20.oldScrollTop;
            _this20.util.forEach($headers, function ($header) {
              if (scroll > ACCURACY) {
                $header.classList.remove("animate__fadeInDown");
                _this20.util.animateCSS($header, ["animate__fadeOutUp"], true);
                $mask.click();
              } else if (scroll < -ACCURACY) {
                $header.classList.remove("animate__fadeOutUp");
                _this20.util.animateCSS($header, ["animate__fadeInDown"], true);
                $mask.click();
              }
            });
            ...
            var scrollPercent = Math.max(
              Math.min(
                (100 * Math.max(_this20.newScrollTop, 0)) / contentHeight,
                100
              ),
              0
            );
            ...
            var _iterator2 = _createForOfIteratorHelper(_this20.scrollEventSet),
              _step2;
            try {
            ...
            _this20.oldScrollTop = _this20.newScrollTop;
          },
          false
        );
      },
    },
    {
      ...
      value: function onResize() {
        ...
        window.addEventListener(
          "resize",
          function () {
            if (!_this21._resizeTimeout) {
              _this21._resizeTimeout = window.setTimeout(function () {
                _this21._resizeTimeout = null;
                var _iterator3 = _createForOfIteratorHelper(
                    _this21.resizeEventSet
                  ),
                  _step3;
                try {
                ...
                _this21.initMermaid();
                _this21.initSearch();
                var isMobile = _this21.util.isMobile();
      ...
      value: function onClickMask() {
        ...
        document.getElementById("mask").addEventListener(
          ...
          function () {
            ...
            _this22.disableScrollEvent = false;
            document.body.classList.remove("blur");
          },
          false
        );
    ...
    },
    {
      ...
      value: function init() {
        ...
        try {
          ...
          this.initAutoMark();
          window.setTimeout(function () {
            var _this23$config$encryp;
            _this23.initComment();
            if (
              !(
                (_this23$config$encryp = _this23.config.encryption) !== null &&
                _this23$config$encryp !== void 0 &&
                _this23$config$encryp.all
              )
            ) {
              _this23.initToc();
              _this23.initTocListener();
            }
            _this23.onScroll();
            _this23.onResize();
            _this23.onClickMask();

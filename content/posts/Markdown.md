...
<!--more-->![img](https://img-blog.csdnimg.cn/img_convert/a55f759c0d3de6e68a65979cfb5d8a19.png)
...
事实上，编写 Web 内容很麻烦。**WYSIWYG所见即所得** 编辑器帮助减轻了这一任务。但通常会导致代码太糟，或更糟糕的是，网页也会很丑。
...
{{< admonition note 文本右对齐或居中对齐 true >}}
